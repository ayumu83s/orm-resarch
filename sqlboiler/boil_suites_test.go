...
func TestDelete(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsDelete)
...
func TestQueryDeleteAll(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsQueryDeleteAll)
...
func TestSliceDeleteAll(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsSliceDeleteAll)
...
func TestExists(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsExists)
...
func TestFind(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsFind)
...
func TestBind(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsBind)
...
func TestOne(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsOne)
...
func TestAll(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsAll)
...
func TestCount(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsCount)
...
func TestHooks(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsHooks)
...
func TestInsert(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsInsert)
	t.Run("FilmTexts", testFilmTextsInsertWhitelist)
...
func TestToOne(t *testing.T) {
	...
	t.Run("CustomerToStoreUsingStore", testCustomerToOneStoreUsingStore)
	t.Run("FilmToLanguageUsingLanguage", testFilmToOneLanguageUsingLanguage)
	t.Run("FilmToLanguageUsingOriginalLanguage", testFilmToOneLanguageUsingOriginalLanguage)
	...
	t.Run("InventoryToStoreUsingStore", testInventoryToOneStoreUsingStore)
...
func TestToMany(t *testing.T) {
	...
	t.Run("LanguageToOriginalLanguageFilms", testLanguageToManyOriginalLanguageFilms)
	...
	t.Run("StoreToCustomers", testStoreToManyCustomers)
	t.Run("StoreToInventories", testStoreToManyInventories)
...
func TestToOneSet(t *testing.T) {
	t.Run("AddressToCityUsingCity", testAddressToOneSetOpCityUsingCity)
	t.Run("CityToCountryUsingCountry", testCityToOneSetOpCountryUsingCountry)
	t.Run("CustomerToAddressUsingAddress", testCustomerToOneSetOpAddressUsingAddress)
	t.Run("CustomerToStoreUsingStore", testCustomerToOneSetOpStoreUsingStore)
	t.Run("FilmToLanguageUsingLanguage", testFilmToOneSetOpLanguageUsingLanguage)
	t.Run("FilmToLanguageUsingOriginalLanguage", testFilmToOneSetOpLanguageUsingOriginalLanguage)
	t.Run("FilmActorToActorUsingActor", testFilmActorToOneSetOpActorUsingActor)
	t.Run("FilmActorToFilmUsingFilm", testFilmActorToOneSetOpFilmUsingFilm)
	t.Run("FilmCategoryToCategoryUsingCategory", testFilmCategoryToOneSetOpCategoryUsingCategory)
	t.Run("FilmCategoryToFilmUsingFilm", testFilmCategoryToOneSetOpFilmUsingFilm)
	t.Run("InventoryToFilmUsingFilm", testInventoryToOneSetOpFilmUsingFilm)
	t.Run("InventoryToStoreUsingStore", testInventoryToOneSetOpStoreUsingStore)
	t.Run("PaymentToCustomerUsingCustomer", testPaymentToOneSetOpCustomerUsingCustomer)
	t.Run("PaymentToRentalUsingRental", testPaymentToOneSetOpRentalUsingRental)
	t.Run("PaymentToStaffUsingStaff", testPaymentToOneSetOpStaffUsingStaff)
	t.Run("RentalToCustomerUsingCustomer", testRentalToOneSetOpCustomerUsingCustomer)
	t.Run("RentalToInventoryUsingInventory", testRentalToOneSetOpInventoryUsingInventory)
	t.Run("RentalToStaffUsingStaff", testRentalToOneSetOpStaffUsingStaff)
	t.Run("StaffToAddressUsingAddress", testStaffToOneSetOpAddressUsingAddress)
	t.Run("StaffToStoreUsingStore", testStaffToOneSetOpStoreUsingStore)
	t.Run("StoreToAddressUsingAddress", testStoreToOneSetOpAddressUsingAddress)
	t.Run("StoreToStaffUsingManagerStaff", testStoreToOneSetOpStaffUsingManagerStaff)
}

// TestToOneRemove tests cannot be run in parallel
// or deadlocks can occur.
func TestToOneRemove(t *testing.T) {
	t.Run("FilmToLanguageUsingOriginalLanguage", testFilmToOneRemoveOpLanguageUsingOriginalLanguage)
	t.Run("PaymentToRentalUsingRental", testPaymentToOneRemoveOpRentalUsingRental)
}
...
func TestToManyAdd(t *testing.T) {
	...
	t.Run("LanguageToOriginalLanguageFilms", testLanguageToManyAddOpOriginalLanguageFilms)
	...
	t.Run("StoreToCustomers", testStoreToManyAddOpCustomers)
	t.Run("StoreToInventories", testStoreToManyAddOpInventories)
...
func TestToManySet(t *testing.T) {
	t.Run("LanguageToOriginalLanguageFilms", testLanguageToManySetOpOriginalLanguageFilms)
	t.Run("RentalToPayments", testRentalToManySetOpPayments)
}

// TestToManyRemove tests cannot be run in parallel
// or deadlocks can occur.
func TestToManyRemove(t *testing.T) {
	t.Run("LanguageToOriginalLanguageFilms", testLanguageToManyRemoveOpOriginalLanguageFilms)
	t.Run("RentalToPayments", testRentalToManyRemoveOpPayments)
}
...
func TestReload(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsReload)
...
func TestReloadAll(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsReloadAll)
...
func TestSelect(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsSelect)
...
func TestUpdate(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsUpdate)
...
func TestSliceUpdateAll(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsSliceUpdateAll)
...
func TestUpsert(t *testing.T) {
	...
	t.Run("FilmTexts", testFilmTextsUpsert)
